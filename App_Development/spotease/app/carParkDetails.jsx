...
export default function CarParkDetails() {
  const { address, lotsavailable, totallots, carparktype, distanceaway, lat, lng } = useLocalSearchParams();
    ...
    <View style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.distanceContainer}>
          ...
          <Text style={styles.distance}>{Math.round(distanceaway)}m away </Text> 
        </View>
